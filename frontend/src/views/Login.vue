    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-8 pb-6 text-center">
          ...
          <h1 class="text-2xl font-bold text-gray-900">地理知识问答</h1>
          <p class="text-gray-500 mt-2">基于知识图谱的智能地理问答系统</p>
        </div>
          ...
          <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="space-y-4">
            <div>
              ...
              <input
                ...
                required
                placeholder="请输入用户名"
                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-emerald-500 transition-colors"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 rounded-xl font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:from-emerald-600 hover:to-teal-700 transition-all"
            >
